...
curl -s -X POST 'http://localhost:3000/api/admin/run-tier1?wait=true' | jq '{completed,sessionsFound,rowsUpserted,upsertError,snapshotsInserted,snapshotInsertError,error}'
```
