...
const webPushProvider = require('./notification-provider-webpush');
const {
...
async function sendNotification({
  ...
  if (provider === 'webpush') {
    const result = await webPushProvider.sendWebPush({
      subscription,
      title,
      message,
      clickUrl,
    ...
    return {
      ...
      deactivateSubscription: result.deactivateSubscription,
      vapidConfigError: result.vapidConfigError,
      transport: 'webpush',
    };
  }
