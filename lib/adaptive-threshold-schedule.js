...
function collectDueDateScanCandidates(sessions, {
  ...
  const candidates = [...byDate.values()].sort((a, b) => {
    if (a.watchedDueCount !== b.watchedDueCount) return b.watchedDueCount - a.watchedDueCount;
    if (a.mostOverdueMinutes !== b.mostOverdueMinutes) return b.mostOverdueMinutes - a.mostOverdueMinutes;
