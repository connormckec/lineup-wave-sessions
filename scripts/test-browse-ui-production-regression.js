...
{
  assert.match(html, /\/lineup-config\.js\?v=16/);
  assert.match(html, /\/session-capacity-config\.js\?v=16/);
  assert.match(html, /\/browse-availability-view\.js\?v=16/);
  assert.match(html, /\/browse-ui-semantics\.js\?v=16/);
  assert.match(html, /\/browse-live-schedule\.js\?v=16/);
