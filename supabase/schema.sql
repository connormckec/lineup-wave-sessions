...
create table if not exists current_sessions (
  ...
  -- pending | checking | checked_with_slots | checked_packed | checked_open_no_slots_visible | failed_modal_open | failed_selector | failed_parse | failed_timeout | unknown
  detail_status text,
  detail_error text,
